...
inputFile: squads/conteudo-instagram/output/news-ranking.md
outputFile: squads/conteudo-instagram/output/angles.md
---
...
- `squads/conteudo-instagram/output/news-ranking.md` — Ranking de pautas (usuário selecionou uma no step-03)
- `squads/conteudo-instagram/pipeline/data/domain-framework.md` — Definições dos 5 ângulos e drivers psicológicos
