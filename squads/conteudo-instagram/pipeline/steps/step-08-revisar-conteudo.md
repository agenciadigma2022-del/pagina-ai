...
outputFile: squads/conteudo-instagram/output/review.md
---
...
- `squads/conteudo-instagram/output/carousel-draft.md` — Rascunho aprovado pelo usuário no step-07
- `squads/conteudo-instagram/pipeline/data/quality-criteria.md` — Rubrica de avaliação com 9 critérios (C1-C9)
- `squads/conteudo-instagram/pipeline/data/anti-patterns.md` — Erros conhecidos de conteúdo para PMEs
...
8. Salve em `squads/conteudo-instagram/output/review.md`
