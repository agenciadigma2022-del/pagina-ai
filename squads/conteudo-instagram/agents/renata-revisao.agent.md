---
id: "squads/conteudo-instagram/agents/renata-revisao"
name: "Renata Revisão"
...
- **Reads from**: squads/conteudo-instagram/output/carousel-draft.md (conteúdo a revisar)
- **Reads from**: squads/conteudo-instagram/pipeline/data/quality-criteria.md (rubrica de avaliação)
- **Reads from**: squads/conteudo-instagram/pipeline/data/anti-patterns.md (erros conhecidos)
- **Writes to**: squads/conteudo-instagram/output/review.md
