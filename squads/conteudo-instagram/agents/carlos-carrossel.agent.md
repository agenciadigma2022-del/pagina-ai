---
id: "squads/conteudo-instagram/agents/carlos-carrossel"
...
- **Reads from (task 1)**: squads/conteudo-instagram/output/news-ranking.md (pauta selecionada)
- **Reads from (task 1)**: squads/conteudo-instagram/pipeline/data/domain-framework.md (definições de ângulos)
- **Writes to (task 1)**: squads/conteudo-instagram/output/angles.md
- **Reads from (task 2)**: squads/conteudo-instagram/output/angles.md (ângulo selecionado)
- **Reads from (task 2)**: squads/conteudo-instagram/pipeline/data/tone-of-voice.md (seleção de tom)
- **Reads from (task 2)**: squads/conteudo-instagram/pipeline/data/output-examples.md (referência de qualidade)
- **Writes to (task 2)**: squads/conteudo-instagram/output/carousel-draft.md
