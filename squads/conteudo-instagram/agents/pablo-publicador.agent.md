---
id: "squads/conteudo-instagram/agents/pablo-publicador"
...
- **Reads from**: squads/conteudo-instagram/output/slides/ (PNGs renderizados pela Duda)
- **Reads from**: squads/conteudo-instagram/output/carousel-draft.md (legenda + hashtags oficiais)
- **Writes to**: squads/conteudo-instagram/output/post-confirmation.md (confirmação de publicação)
