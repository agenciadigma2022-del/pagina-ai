---
id: "squads/conteudo-instagram/agents/duda-design"
name: "Duda Design"
...
- **Reads from (task 1)**: squads/conteudo-instagram/output/carousel-draft.md (conteúdo aprovado)
- **Reads from (task 1)**: squads/conteudo-instagram/pipeline/data/brand-guidelines.md (especificações visuais)
- **Writes to (task 1)**: squads/conteudo-instagram/output/slides-html/ (arquivos HTML/CSS)
- **Writes to (task 2)**: squads/conteudo-instagram/output/slides/ (imagens PNG renderizadas)
