...
inputFile: squads/rss-instagram/output/slides/
outputFile: squads/rss-instagram/output/post-confirmation.md
---
...
- `squads/rss-instagram/output/slides/` — PNGs aprovados no step-12 para upload
- `squads/rss-instagram/output/carousel-draft.md` — Legenda e hashtags oficiais aprovados
