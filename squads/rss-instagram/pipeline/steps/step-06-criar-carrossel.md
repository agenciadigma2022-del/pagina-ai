...
inputFile: squads/rss-instagram/output/angles.md
outputFile: squads/rss-instagram/output/carousel-draft.md
---
...
- `squads/rss-instagram/output/angles.md` — Os 5 ângulos gerados (usuário selecionou um no step-05)
- `squads/rss-instagram/pipeline/data/tone-of-voice.md` — 6 opções de tom para confirmação com o usuário
- `squads/rss-instagram/pipeline/data/output-examples.md` — Exemplos completos de referência de qualidade
- `squads/rss-instagram/pipeline/data/anti-patterns.md` — Erros comuns a evitar
...
9. Salve em `squads/rss-instagram/output/carousel-draft.md`
