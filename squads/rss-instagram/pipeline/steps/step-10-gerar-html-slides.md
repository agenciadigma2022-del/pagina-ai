...
outputFile: squads/rss-instagram/output/slides-html/
---
...
- `squads/rss-instagram/pipeline/data/brand-guidelines.md` — cores, tipografia, template base e regras de design da ATRAE
- `squads/rss-instagram/output/carousel-draft.md` — conteúdo aprovado pela Renata (step-08) e pelo usuário (step-09)
